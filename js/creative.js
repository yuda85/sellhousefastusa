...
googleAutocomplete2 = {
  autocompleteField: function (fieldId) {
    (autocomplete2 = new google.maps.places.Autocomplete(document.getElementById(fieldId))), {types: ["geocode"]};
...
(function ($) {
  ...
  $(".help-item").click(function () {
    ...
    $(".accordion-item").hide();
    $(".accordion-item[data-target=" + target + "]").fadeIn();
  });
  ...
  $('.accordion-item[data-target="1"]').fadeIn();
